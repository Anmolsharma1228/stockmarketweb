  ...
  return (
    <BrowserRouter>
      ...
      <Routes>
        ...
        <Route
          path="/Services/StartUpReg/Proprietorship"
          element={<PropriRegs />}
        ></Route>
        <Route
          path="/Services/StartUpReg/PartnershipFirm"
          element={<PartnershipFirmReg />}
        ></Route>
        <Route
          path="/Services/StartUpReg/LLPRegistration"
          element={<LLPRegistration />}
        ></Route>
        <Route
          path="/Services/StartUpReg/PrivateLtdCompany"
          element={<PrivateLtdComReg />}
        ></Route>
        <Route
          path="/Services/StartUpReg/PublicLtdCompany"
          element={<PublicLtdComReg />}
        ></Route>
        <Route
          path="/Services/StartUpReg/OnePersonCompany"
          element={<OnePersonReg />}
        ></Route>
        <Route
          path="/Services/StartUpReg/NgoTrust"
          element={<NgoTrust />}
        ></Route>
